...
public class ReferenceApplicationService {
    ...
    public CompletableFuture<Object> createNewReference(String newId, ReferenceType referenceType, Set<String> eventIdSet, String description) {
        return commandGateway.send(new CreateReferenceCommand(newId, referenceType, eventIdSet, description));
    }
